...
void main() {
    ...
    float printTime = (float)clock()/CLOCKS_PER_SEC;
    printf("calctime %.10f\n",endTime - startTime);
    printf("printtime %.10f\n",endTime - printTime);
}
